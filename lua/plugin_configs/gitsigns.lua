require('gitsigns').setup {
  ...
  on_attach                    = function(bufnr)
    ...
    map('n', '<leader>tb', gitsigns.toggle_current_line_blame, { desc = "Git toggle current_line_blame" })
    ...
    map('n', '<leader>td', gitsigns.toggle_deleted, { desc = "Git toogle deleted" })
